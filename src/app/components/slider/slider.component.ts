...
export class SliderComponent implements OnInit, AfterViewInit {
    ...
    moovEndSetParamNext(): void {
        this.setCurentStyle(this.prevSlideImg, 0, 0, '0', -this.InitPosition / 2, this.InitPosition);
    ...
    initSliders() {
        ...
        if (this.countSliders > 2) {
            for (let i = 0; i <= this.countSliders; i += 1) {
                if (i === 0) {
                    this.setCurentStyle(i, 3, 1, '1s', 0, 0);
                } else if (i === 1) {
                    this.setCurentStyle(i, 1, 1, '1s', -this.InitPosition / 2, this.InitPosition);
                } else if (i === 2) {
                    this.setCurentStyle(i, 0, 0, '0', this.InitPosition / 2, -this.InitPosition);
                } else {
                    this.setCurentStyle(i, 0, 0, '0', this.InitPosition / 2, -this.InitPosition);
                }
            }
